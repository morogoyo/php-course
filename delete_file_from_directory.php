...
file is not complete as i have been able to traverse thru the directories and the files in them but 
i can get the filemtime to convert from epoch to its actual modified time. while i am using the foreach loop on the 
directory content 
